...
public class ChickenManager : MonoBehaviour {
    ...
    public List<Feed> Feed_GradeA { get; private set; }
    public List<Feed> Feed_GradeB { get; private set; }
    public List<Feed> Feed_GradeC { get; private set; }
    public List<Feed> Feed_GradeS { get; private set; }
    ...
    public void InitializeChicken(Chickens grade, string name = "")
    {
    ...
    // chicken acquisation should be done in ChickenManager and not in BarnController
    public void InitializeChicken(Chickens grade, int age, string name="")
    {
        Chicken chicken = new Chicken();
    ...
    public int GetChickenCountOfType(Chickens grade)
    {
        switch (grade)
        {
            case Chickens.Grade_A:
    ...
    public bool RemoveChicken(int id, Chickens grade)
    {
